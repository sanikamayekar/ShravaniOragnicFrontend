      ...
      <div className="mx-6 md:mx-32">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="relative flex justify-center items-end gap-6 pt-4 max-w-full overflow-hidden">
            ...
            <div className="w-64 sm:w-72 md:w-80 lg:w-96 h-screen max-h-[100vh] rounded-xl overflow-hidden">
              <Image
                src={farmersMarket}
    ...
    <section className="bg-[#D9D9D95E] h-[633px] relative overflow-hidden my-4">
      <div className="mx-6 md:mx-32 py-8 relative">
        <div className="max-w-[1100px] mx-auto grid md:grid-cols-2 gap-10 items-start h-full relative">
          ...
          <div className="relative w-full max-w-[433px] h-[580px] rounded-xl overflow-hidden mt-10 md:mt-0 z-0">
            <Image
        ...
        <div className="absolute top-[180px] left-0 z-20 max-w-[760px] bg-[#FFF8F1] rounded-xl p-6">
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="flex flex-col items-center text-center space-y-2">
                <div className="w-12 h-12 bg-[#E8F5E8] rounded-xl flex items-center justify-center">
        ...
        <div className="absolute bottom-8 left-0 right-0 z-20 max-w-[760px] bg-white rounded-xl p-6 flex items-center gap-6">
          <Image
            src="/images/about/testimonial.jpg"
            alt="Customer"
            width={90}
            height={90}
            className="rounded-xl object-cover w-[90px] h-[90px] flex-shrink-0"
          />
    ...
    <section className="bg-white py-20">
      <div className="mx-6 md:mx-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {blogs.map((blog) => (
            <div key={blog.id} className="rounded-xl overflow-hidden bg-[#F1F1F1] hover:shadow-lg transition-shadow duration-500 group flex flex-col h-[520px]">
    ...
    <section className="bg-[#f5f5f5] py-0 md:py-0 mt-12">
      <div className="mx-6 md:mx-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {/* Card 1 */}
          <div className="bg-white p-6 rounded-xl text-center border border-gray-200 flex flex-col">
            <Image 
              src="/images/bestsellers/traditional-rice.jpg" 
              alt="Traditional Rice Varieties" 
              width={400} 
              height={300} 
              className="object-cover w-full h-[250px] mb-4 rounded-xl" 
            />
            ...
            <div className="mt-auto">
              <button className="bg-[#57951BF7] text-white py-3 px-10 rounded-xl text-lg font-roboto w-full">Shop Now</button>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl text-center border border-gray-200 flex flex-col">
            ...
            <p className="text-xl font-roboto text-[#21613F] font-bold mb-6">From ₹520</p>
            <div className="mt-auto">
              <button className="bg-[#57951BF7] text-white py-3 px-10 rounded-xl text-lg font-roboto w-full">Shop Now</button>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl text-center border border-gray-200 flex flex-col">
            ...
            <p className="text-xl font-roboto text-[#21613F] font-bold mb-6">From ₹250</p>
            <div className="mt-auto">
              <button className="bg-[#57951BF7] text-white py-3 px-10 rounded-xl text-lg font-roboto w-full">Shop Now</button>
            </div>
          </div>
