...
const Footer = () => {
  return (
    <footer>
      <div className="bg-[#2a6b33] text-white py-16 px-6 md:px-32">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            
            {/* Column 1: About */}
            <div className="space-y-4">
              <h4 className="text-xl lg:text-2xl font-bold mb-6 text-white font-['Playfair_Display'] leading-tight">
                Shravani Organic Life
              </h4>
              <p className="text-base lg:text-lg text-gray-200 leading-relaxed font-['Roboto'] font-light">
          ...
          {/* Social Media Icons */}
          <div className="flex justify-center gap-6 mt-12 pt-8 border-t border-[#3d7a46]">
